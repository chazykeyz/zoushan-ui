      ...
      <div className="col-span-10 col-start-2 flex felx-wrap grid grid-cols-1 md:grid-cols-2 items-center mt-10 ">
        <div align="justify">
          ...
          <div className="my-4">
            ...
            still is till date. <br />
            <br /> My mother is my biggest inspiration. Growing up, I watched
            her care for her skin using all natural products after her bath, and
            I couldn’t help but notice the healthy glow in her skin all day
            long. She’d always say "organic beauty is the best". In 2016, after
            I lost my mother, I realized that i had fallen in love with organic
            skincare as each time I applied her products on my skin, I felt
            directly connected to her. That feeling inspired my decision to not
            only create an all natural beauty line but also give back to the
            community and since then, my biggest dream has been to create a
            product line that everyone will love regardless of their gender.{" "}
            <br />
